...
// TilingTask and TilingBatch mutations (to be regenerated by Amplify codegen)
export const createTilingTask = /* GraphQL */ `mutation CreateTilingTask($input: CreateTilingTaskInput!, $condition: ModelTilingTaskConditionInput) {
  createTilingTask(input: $input, condition: $condition) {
    id
    projectId
    locationSetId
    annotationSetId
...
export const createTilingBatch = /* GraphQL */ `mutation CreateTilingBatch($input: CreateTilingBatchInput!, $condition: ModelTilingBatchConditionInput) {
  createTilingBatch(input: $input, condition: $condition) {
    id
    tilingTaskId
    batchIndex
    status
