...
export default function ProcessImages({
  ...
  const [selectedProcess, selectProcess] = useState<string | undefined>(
    undefined
  );
  ...
  const [setMessagePreppingStepsCompleted, setMessagePreppingTotalSteps] =
    useUpdateProgress({
    ...
    switch (selectedProcess) {
      ...
      case "Compute image registrations": {
        ...
        const images = await Promise.all(
          ...
          .then((arrays) => arrays.flat().map(({ image }) => image))
