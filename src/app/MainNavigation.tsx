...
import { ProgressIndicators } from '../shared/components/ProgressIndicators';
...
import { setIsAnnotatePathAction, useIsAnnotatePath } from '../features/tasks/taskStore';
...
export default function MainNavigation({ signOut }: { signOut: () => void }) {
  ...
  useEffect(() => {
    ...
    checkToken();
  }, [navigate, queryClient, user.userId]);
