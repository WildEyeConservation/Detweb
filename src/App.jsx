          ...
          <Nav fill activeKey={location.pathname} onSelect={handleSelect}>
            ...
            <IfAdmin session={session}>
              <NavDropdown title="Actions" id="collapsible-nav-dropdown">
                <NavDropdown.Item as={NavLink} eventKey="addFiles">
                  Add Files
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="addGps">
                  Add GPS data{" "}
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="processImages">
                  Process Imagery
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="createTask">
                  Create annotation task
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="launchTask">
                  Launch annotation task
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="launchRegistration">
                  Launch registration task
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="exportData">
                  Export Data
                </NavDropdown.Item>
                <NavDropdown.Item as={NavLink} eventKey="retile">
                  Retile images
                </NavDropdown.Item>
              ...
              <NavDropdown title="Delete" id="collapsible-nav-dropdown">
                <NavDropdown.Item as={NavLink} eventKey="deleteImageSet">
                  Image Set
                </NavDropdown.Item>
              </NavDropdown>
