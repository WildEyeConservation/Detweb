          ...
          >
            ...
            {annotationHook.meta?.isLoading ? (
              ...
              <div>
                {pairToRegister && (
                  <RegisterPair
                    key={pairToRegister.primary + pairToRegister.secondary}
                    images={[
                      imageMetaData[pairToRegister?.primary],
                      imageMetaData[pairToRegister?.secondary],
                    ]}
                    selectedCategoryIDs={selectedCategoryIDs}
                    selectedSet={selectedAnnotationSet}
                    transforms={[
                      imageNeighbours[pairToRegister?.primary][
                        pairToRegister?.secondary
                      ].tf,
                      imageNeighbours[pairToRegister?.secondary][
                        pairToRegister?.primary
                      ].tf,
                    ]}
                    next={() => {}}
                    prev={() => {}}
