...
import { makeProjection, createImageMap, addImageTiles, storedZoomToMapZoom, mapZoomToStoredZoom } from '../../../shared/imaging/imageTiles';
import { ImageContext } from '../imageContext';
import useImageMenuItems from '../../images/useImageMenuItems';
import { isWithinLocationBounds } from '../../../shared/imaging/locationBounds';
import { resolveCategoryIdForSet } from '../sets/categoryMatching';
import { canonicalHotkeyFromParsed, normalizeShortcutKey } from '../../../shared/utils/hotkeys';
import { NavButtons } from '../../../shared/components/NavButtons';
import ChangeCategoryModal from '../ChangeCategoryModal';
import type { CategoryType, ExtendedAnnotationType } from '../../../shared/api/schemaTypes';
import type { AnnotationImage, AnnotationLocation } from '../../../shared/types/annotationTypes';
import { buildAnnotationFeatureCollection, buildAnnotationPopupLines, isFalseNegative, type AnnotationFeatureProperties } from './annotationFeatures';
import { buildAnnotationMenuItems, buildImageMenuItems } from './annotationMenus';
import { AnnotationLegendOverlay, ContextMenuOverlay, ImageFileStatusOverlay, type MenuState } from './AnnotatorOverlays';
import useImageFileSource from '../../../shared/imaging/useImageFileSource';
import MapRotateControl from '../../../shared/imaging/MapRotateControl';
import { useCategories } from '../../../shared/data/project';
import { useCurrentProject, useProjectId } from '../../../shared/data/projectScope';
import { useAllUsers } from '../../../shared/data/users';
import { setCurrentCategoryAction, useCurrentCategory } from '../annotatorUiStore';
import { addAnnotationMarkerLayers, ANNOTATION_MARKER_LAYERS, registerAnnotationMarkerImages } from './annotationMarkerLayers';
