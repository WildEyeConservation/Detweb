...
import useTaskCompletion, { WaitingOverlay } from '../tasks/useTaskCompletion';
...
import { useImageInfoTags } from '../info-tags/useInfoTags';
import type { CategoryType } from '../../shared/api/schemaTypes';
import type { AnnotationLocation, AnnotationWorkspaceProps, TaskAcknowledgement } from '../../shared/types/annotationTypes';
import { publishSharedDefaultZoom, subscribeToSharedDefaultZoom } from '../../shared/imaging/defaultZoomEvents';
...
import { useCurrentTaskTag, useIsAnnotatePath } from '../tasks/taskStore';
import { setExpandLegendAction, useExpandLegend } from './annotatorUiStore';
