...
import { setCurrentAnnoCountAction, setCurrentTaskTagAction } from '../tasks/taskStore';
import type { AnnotationImage } from '../../shared/types/annotationTypes';
...
export function ImageContextFromHook({
  ...
  const [startLoadingTimestamp, ] = useState<number>(Date.now());
  ...
  const create = useCallback(
    ...
    [hook, prevImages, onAnnotationCreate, setCurrentAnnoCount]
  );
  ...
  const update = useCallback(
    ...
    [hook, setCurrentAnnoCount, prevImages]
  );
