...
import { useMyOrganizations, useMyMemberships } from '../../shared/data/memberships';
import { surveyDetailsKey, surveyDetailsQuery } from '../../shared/data/surveyDetails';
import { surveyNamesQuery } from '../../shared/data/surveyNamesQuery';
...
import { useActiveUploadProjectId } from '../uploads/uploadUi';
import { logAdminAction } from '../../shared/logging/adminActionLogger';

const NewSurvey = lazy(() => import('./NewSurveyModal'));
const Upload = lazy(() => import('../uploads/FilesUploadComponent'));
const AddSet = lazy(() => import('./AddAnnotationSetModal'));
const Details = lazy(() => import('../annotation/AnnotationCountModal'));
const EditSet = lazy(() => import('../annotation/sets/EditAnnotationSet'));
const Results = lazy(() => import('../results/AnnotationSetResults'));
const Launch = lazy(() => import('./LaunchAnnotationSetModal'));
const Generate = lazy(() => import('../results/GenerateJollyResults'));
