...
import { uploadOrchestrator } from '../uploads/core/UploadOrchestrator';
...
import { FilesUploadForm, UploadWizardStep } from '../uploads/FilesUploadComponent';
import { saveShapefileForProject } from '../../shared/utils/shapefileUtils';
...
export default function NewSurveyModal({
  ...
  async function handleSave() {
    ...
    try {
      ...
      alert(error instanceof Error ? getErrorMessage(error) : 'Unable to save. Please try again.');
    } finally {
      setLoading(false);
    }
  }
