...
import type { TiledLaunchRequest } from '../tasks/LaunchTask';
...
export default function TileConfiguration({
  ...
  useEffect(() => {
    ...
    setTransectSubsetSteps((prev) => {
      const next = { ...prev };
      for (const g of transectGroupStats) {
  ...
  }, [minSidelap, specifyTileDimensions, horizontalTiles, effectiveImageWidth, width, specifyOverlapInPercentage]);
  ...
  }, [minOverlap, specifyTileDimensions, verticalTiles, effectiveImageHeight, height, specifyOverlapInPercentage]);
  ...
  }, [minSidelapPercentage, specifyTileDimensions, horizontalTiles, effectiveImageWidth, width, specifyOverlapInPercentage]);
  ...
  }, [minOverlapPercentage, specifyTileDimensions, verticalTiles, effectiveImageHeight, height, specifyOverlapInPercentage]);
  ...
  useEffect(() => {
    async function getAllImages() {
      ...
      const imagesArr: ImageData[] = (all).map((img) => ({
