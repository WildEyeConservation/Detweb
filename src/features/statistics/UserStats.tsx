...
import { useMyMemberships, useMyOrganizations } from '../../shared/data/memberships';
import { client } from '../../shared/api/appClient';
import { useDialogRoute } from '../../shared/routing/useDialogRoute';
import { dialogDate, dialogIds } from '../../shared/routing/dialogValues';
import DialogNotice from '../../shared/routing/DialogNotice';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';
import type { UserStatsType } from '../../shared/api/schemaTypes';
import exportFromJSON from 'export-from-json';
import { useUsers } from '../../shared/api/apiInterface';
import Select from 'react-select';
import { Card, Button, Spinner } from 'react-bootstrap';
const SnapshotStatsModal = lazy(() => import('../results/SnapshotStatsModal'));
...
export default function UserStats() {
  ...
  useEffect(() => {
    ...
    loadProjects();
  }, [myMembershipHook.data, myOrganizationHook.data]);
  ...
  useEffect(() => {
    ...
    setStats(newStats);
  }, [project, startDate, endDate, userStats, selectedSets, startString, endString]);
  ...
  async function queryObservations(
    ...
    return allObs.map(o => ({
      ...
      confidence: (o).location?.confidence ?? null,
    }));
  }
