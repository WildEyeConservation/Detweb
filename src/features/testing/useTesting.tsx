...
import type { Identifiable } from '../tasks/TaskBuffer';
import { useCategories } from '../../shared/data/project';
import { useCurrentMembershipRow, useCurrentProject, useProjectId } from '../../shared/data/projectScope';
...
export default function useTesting() {
  ...
  const fetchPrimaryLocations = useEventCallback(async function fetchPrimaryLocations(presets: { testPresetId: string }[]) {
  ...
  }, [currentPM, fetchPrimaryLocations, project.id]);
