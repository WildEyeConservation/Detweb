...
import { applyActiveMarkerStyle } from '../../shared/imaging/activeMarkerStyle';
import { getTileBlob } from '../../shared/imaging/StorageLayer';
import type { Schema } from '../../shared/api/client-schema';
import { fetchInfoTagDataForSet, formatInfoTagsForDisplay, infoTagNamesFor } from '../info-tags/infoTags';
...
export default function QCAnnotationReview({
  ...
  }, [image?.id, sourceKey, scale, zoomOffset, image, px2lngLat, annotation.x, annotation.y, displayCategory?.name, updateVisibleTiles]);
  ...
  }, [annotation.categoryId, commitReview, next, startWaiting]);
  ...
  const handleRelabel = useCallback(
    ...
    [commitReview, next, startWaiting]
  );
