import type { ObservationType } from '../../shared/api/schemaTypes';
...
type Props = {
  ...
  ) => Promise<Pick<ObservationType, 'owner' | 'annotationCount' | 'timeTaken' | 'waitingTime'>[]>;
};
  ...
  const handleRunSnapshot = async () => {
    ...
    for (const s of selectedSets || []) {
      ...
      observations.forEach((o) => {
        ...
        const sighting = (o.annotationCount ?? 0) > 0 ? 1 : 0;
