import { CHAIN_LOCATION_SOURCES } from './chainLocationSources';
...
import { IndividualIdMap, type MapInstanceCallback, type MapMarker, type MarkerKind } from '../individual-id/IndividualIdMap';
import type { LocationOverlayRow, LocationSourceConfig } from '../individual-id/MapLocationOverlay';
