...
import { makeTransform } from '../../shared/imaging/transforms';
...
import { solveHomography, MIN_HOMOGRAPHY_POINTS, type Point } from './homographyMath';
...
export function HomographyWorkbench({
  ...
  const initialPointsRef = useLatestRef(initialPoints);
  ...
  }, [firstImageId, secondImageId, initialPointsRef]);
