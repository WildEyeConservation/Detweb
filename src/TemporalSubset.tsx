...
const TemporalSubset: React.FC<CreateSubsetModalProps> = ({ show, handleClose, selectedImageSets }) => {
    ...
    return (
        <Modal show={show} onHide={handleClose} size="lg">
            <Modal.Header closeButton>
                <Modal.Title>Define temporal subsets</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {loading && (
                    <div style={{
                ...
                <div style={{ margin: '20px 0' }}>
                    ...
                    {timeRanges.map((range, index) => (
                        <div key={index} style={{ marginBottom: '10px' }}>
                            <Slider
                                ...
                                tipFormatter={value => DateTime.fromMillis(value).toFormat('yyyy-MM-dd HH:mm:ss')}
                            />
                            ...
                            {isMultipleRange && (
                                <Button variant="danger" onClick={() => removeRange(index)} style={{ marginTop: '10px' }}>
                                    Remove Range
                                </Button>
                            )}
                        </div>
                    ...
                    {isMultipleRange && (
                        <Button variant="primary" onClick={addRange} style={{ marginTop: '10px' }}>
                            Add Range
                        </Button>
                    )}
                </div>
                <Form.Check 
                    type="switch"
                    id="multiple-range-switch"
                    label="Enable Multiple Ranges"
                    checked={isMultipleRange}
                    onChange={() => setIsMultipleRange(!isMultipleRange)}
                />
