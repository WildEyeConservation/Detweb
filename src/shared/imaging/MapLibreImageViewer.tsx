...
import type { ImageType } from '../api/schemaTypes';
import type { Point } from '../../features/homography/homographyMath';
...
export function MapLibreImageViewer({
  ...
  }, [map, points, lngLat2px, setPoints, image.width, image.height, onAction]);
  ...
  }, [map, lngLat2px, setPoints, onAction]);
