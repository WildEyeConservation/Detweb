...
import type { ExtendedAnnotationType } from '../../../../../src/shared/api/schemaTypes';
import { buildAnnotationFeatureProperties } from '../../../../../src/features/annotation/annotator/annotationFeatures';
