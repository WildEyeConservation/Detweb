CALL aws cognito-idp admin-create-user --user-pool-id %1 --username jjnaude --region eu-west-2 --user-attributes Name=email,Value=naude.jj@gmail.com --message-action SUPPRESS --temporary-password Password21#
...
CALL aws dynamodb update-item --table-name User-%2-NONE --key file://key.json --expression-attribute-names file://expression-attribute-names.json ^
    ...
    --expression-attribute-values file://expression-attribute-values.json --region af-south-1