...
The frontend is organized into application setup, feature folders, and shared
modules. See [the source layout guide](src/README.md) for folder ownership,
placement conventions, and validation commands.
