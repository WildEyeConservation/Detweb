...
exports.handler = async (event) => {
  ...
  const dynamoClient = new import_client_dynamodb.DynamoDBClient({ region: "af-south-1" });
  ...
  try {
    ...
    const email = "";
    const temporaryPassword = "adminTempPassword";
    const apiId = process.env.API_ID;
    const adminUsername = "admin";
    const adminEmail = "";
    const adminTempPassword = "adminTempPassword";
